				...
				if(isset($_POST['add_student'])){
					...
					<form action="add_student.php" method="post">
						...
						<tr>
    						...
    						<?php
    							// Fetch the course options from the database
    							$courses = ['CSE', 'ECE', 'EEE', 'ME', 'CE']; // Replace with your actual database query

    							// Loop through the course options and generate the dropdown list
